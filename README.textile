...
Just copy the bump folder wherever you want it. Then require it where you need it:

<pre>local bump = require 'bump'</pre>

Notice that the folder you need to copy is not the one which is next to this README, *not the one that contains it*. In other words, if you have downloaded this from the internet and have it on a folder called bump.lua, then you need to copy bump.lua/bump/ to your project.

Please make sure that you read the license, too (for your convenience it's now included inside the bump folder, too.
